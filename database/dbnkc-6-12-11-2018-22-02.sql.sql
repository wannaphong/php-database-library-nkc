...
--
-- Host: localhost:3306
-- Generation Time: Dec 06, 2018 at 10:01 PM
...
INSERT INTO `Librarian` (`LibrarianId`, `IDcard`, `username`, `password`, `Name`, `Address`, `status`) VALUES
(1, '1319800229201', 'tontan', '1234', 'วรรณพงษ์ ภัททิยไพบูลย์', '112 หมู่7 ต.หนองกอมเกาะ อ.เมือง จ.หนองคาย 43000', 'admin'),
(3, '99', 'a', 'a', 'นายสมชาย   บุญ', '112', 'user');
